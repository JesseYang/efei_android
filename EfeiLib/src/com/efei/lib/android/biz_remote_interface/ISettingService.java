...
public interface ISettingService
{
	...
	/**
	 * 获取个人信息：get@/student/students/info → student/students_controller#info</br>
	 * <b>参数：</b>无</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN
	 * <li>name：姓名
	 * <li>email：邮箱地址，若为空表示没有
	 * <li>mobile：手机号
	 */
	...
	/**
	 * 修改姓名：put@/student/students/rename → student/students_controller#rename
	 * <b>参数：</b>
	 * <li>name：新名字</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN
	...
	/**
	 * 修改密码：put@/student/students/change_password → student/students_controller#change_password</br>
	 * <b>参数：</b>
	 * <li>password：密码
	 * <li>new_password：新密码</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN，WRONG_PASSWORD
	 * @return 
	 */
	...
	/**
	 * 修改邮箱：put@/student/students/change_email → student/students_controller#change_email</br>
	 * <b>参数：</b>
	 * <li>email：邮箱地址</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN，USER_EXIST
	 * @return 
	 */
	...
	/**
	 * 修改手机号：put@/student/students/change_mobile → student/students_controller#change_mobile</br>
	 * <b>参数：</b>
	 * <li>mobile：手机号</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN，USER_EXIST
	...
	/**
	 * 修改手机号时输入短信验证码：post@/student/students/verify_mobile → student/students_controller#verify_mobile</br>
	 * <b>参数：</b>
	 * <li>verify_code：验证码</br>
	 * <b>返回值：</b>
	...
	/**
	 * 获取老师列表：get@/student/teachers → student/teachers_controller#index</br>
	 * <b>参数：</b>
	 * <li>scope：取1，表示查找当前用户的教师</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN
	 * <li>teachers：数组，表示教师列表，每一个元素为一个哈希，结构为：
	 * 		id：教师id
	 * 		name：教师姓名
	 * 		subject：教师科目
	 * 		school：教师学校名称
	...
	/**
	 * 搜索教师：get@/student/teachers → student/teachers_controller#index</br>
	 * <b>参数：</b>
	 * <li>scope：0，表示全体教师范围内搜索
	 * <li>subject：整数表示的科目
	 * <li>name：教师姓名</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN
	...
	/**
	 * 添加教师：post@/student/teachers → student/teachers_controller#create</br>
	 * <b>参数：</b>
	 * <li>teacher_id：教师id
	 * <li>class_id：班级id，若为空则不指定班级</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN，TEACHER_NOT_EXIST
	 * @return 
	 */
	...
	/**
	 * 删除教师：delete@/student/teachers/#{teacher_id} → student/teachers_controller#destroy</br>
	 * <b>参数：</b>
	 * <li>teacher_id（url）：教师id</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN，TEACHER_NOT_EXIST
	 * @return 
	 */
	...
	/**
	 * 提交反馈意见：post@student/feedbacks → student/feedbacks_controller#create</br>
	 * <b>参数：</b>
	 * <li>content：反馈意见内容</br>
	 * <b>返回值：</b>
	 * <li>code：REQUIRE_SIGNIN
	 * @return 
	 */
